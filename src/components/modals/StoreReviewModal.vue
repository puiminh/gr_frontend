<template>
    <div class="p-8 bg-white rounded-3xl relative min-w-96">
        ...
        <div class="rounded-2xl border-2 border-purple-600 mx-8">
            <textarea v-model="review.comment" class="w-full h-16 bg-inherit px-4 py-2 overflow-hidden text-slate-800" type="text"></textarea>
        </div>
...
export default {
    ...
    components: { StarsRating, IconSave },
