<template>
  <div>
    ...
    <div class="broad flex flex-wrap mx-auto w-fit h-fit relative mb-40">
      ...
      <router-link to="/recipeview" class="bg-yellow w-1/4 h-16 rounded-full absolute -bottom-8 centered-axis-x flex items-center justify-between px-6 drop-shadow-lg">
