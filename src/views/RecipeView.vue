<template>
    <div class="body flex min-h-screen">
      ...
      <div class="content-left w-2/3 pl-16 pt-8 item">
        <div class="navbar flex items-center">
          ...
          <h1 class="logo text-4xl font-medium text-white mr-12">Recipes.</h1>
          <div class="searchbar rounded-lg w-3/5 h-16 mx-4 flex items-center">
        ...
        <div class="content mt-12">
          <div class="flex">
            <div class="w-2/3 flex flex-col">
              <p class="author font-mono text-xl">Julian Nguyen</p>
              <p class="title text-7xl text-white mt-4">Chicken Tikka Masala</p>
              <div class="flex items-center gap-4 mt-8">
                <StarsRating class="flex align-start -ml-2"></StarsRating>
                <p class="font-mono text-slate-400 font-bold text-sm">4 out of 5</p>
              </div>
            </div>
            <div class="image-holder">
              <img class="h-80 absolute" src="https://veerji.ca/wp-content/uploads/2021/12/malai-kofta-indian-vegetarian-meatballs-curry-traditionally-served-hot-flatbread-tandoori-rumali-roti-naan-traditional-158606665-removebg-preview.png" alt="">
            </div>            
          </div>


          <div class="description mt-8">
            <p class="title text-white text-2xl font-extralight">Introduction</p>
            <p class="description-text font-mono text-xl text-slate-300 mt-4">
          ...
          <!-- <div class="instruction mt-8">
            <p class="title text-white text-2xl font-extralight">Introduction</p>
            <p class="instruction-text font-mono text-xl text-slate-300 mt-4">
              Lorem ipsum dolor sit amet consectetur adipiscing elit facilisi a, posuere class magna elementum montes feugiat cubilia aliquet. Vel cursus sollicitudin nunc fringilla justo cum urna at potenti pellentesque tincidunt fusce, tellus inceptos morbi nostra metus varius turpis interdum nisl lacus. Porta in non porttitor venenatis suspendisse, cras dis curae.
            </p>
          </div> -->
        </div>
      </div>
      <div class="content-right flex-none flex flex-col w-1/3 bg-white m-4 justify-between">
        ...
        <div class="switch-menu self-center bg-slate-200 h-20 mx-4 mb-4 px-8 py-2 gap-6 flex items-center justify-between rounded-3xl">
          <div
            @click="changeRightMode(1)"
            class="ingredient-menu rounded-lg p-2 cursor-pointer" 
          ...
          <div
            ...
            class="video-menu rounded-lg p-2 cursor-pointer" 
          ...
          <div
            ...
            class="comment-menu rounded-lg p-2 cursor-pointer" 
          ...
          <div
            ...
            class="image-menu rounded-lg p-2 cursor-pointer" 
...
.text, .description-text, .instruction-text {
